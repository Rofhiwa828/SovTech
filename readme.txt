...
3.  The test are Junit tests where we use the RunCuke class to execute them
5.  The reporting used is Extent reports, after a test run the report can be found in the following directory /cib-api-restAssured/Output
